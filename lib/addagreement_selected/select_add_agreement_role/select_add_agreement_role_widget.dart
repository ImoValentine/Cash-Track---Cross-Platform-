...
import 'select_add_agreement_role_model.dart';
export 'select_add_agreement_role_model.dart';

class SelectAddAgreementRoleWidget extends StatefulWidget {
  const SelectAddAgreementRoleWidget({
    super.key,
  ...
  @override
  State<SelectAddAgreementRoleWidget> createState() =>
      _SelectAddAgreementRoleWidgetState();
}

class _SelectAddAgreementRoleWidgetState
    extends State<SelectAddAgreementRoleWidget> {
  late SelectAddAgreementRoleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectAddAgreementRoleModel());
                                ...
                                Flexible(
                                  child: Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Text(
                                        'I am the debtor/\nI am receiving the loan payment \nAnd will pay it back on specified date',
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Outfit',
