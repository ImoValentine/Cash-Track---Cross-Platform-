...
import 'schema/agreements_record.dart';
import 'schema/user_details_record.dart';
import 'schema/signed_agreements_record.dart';
...
export 'schema/agreements_record.dart';
export 'schema/user_details_record.dart';
export 'schema/signed_agreements_record.dart';
...
/// Functions to query AgreementsRecords (as a Stream and as a Future).
Future<int> queryAgreementsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AgreementsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AgreementsRecord>> queryAgreementsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AgreementsRecord.collection,
      AgreementsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AgreementsRecord>> queryAgreementsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query SignedAgreementsRecords (as a Stream and as a Future).
Future<int> querySignedAgreementsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SignedAgreementsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SignedAgreementsRecord>> querySignedAgreementsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SignedAgreementsRecord.collection,
      SignedAgreementsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SignedAgreementsRecord>> querySignedAgreementsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
